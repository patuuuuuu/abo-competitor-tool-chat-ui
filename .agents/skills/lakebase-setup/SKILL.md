...
See `.Codex/skills/add-tools/examples/lakebase.yaml` for the YAML snippet.
...
See `.Codex/skills/add-tools/examples/lakebase-autoscaling.yaml` for the YAML snippet.
